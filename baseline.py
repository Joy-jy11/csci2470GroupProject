...
def retrieve_and_eval(text_features: torch.Tensor, image_features: torch.Tensor, top_k: int = 5) -> tuple:
    ...
    for i in range(len(hits)):
        ...
        if hit[0] == i:
            ...
            continue
    return (count1/text_features.shape[0], count5/text_features.shape[0])
...
if __name__ == "__main__":
    ...
    for task_type in ["train", "val", "test"]:
        ...
        acc1, acc5 = retrieve_and_eval(text_features, image_features)
        print(f"-----{task_type}-----")
        print("acc @ 1:", acc1)
        print("acc @ 5:", acc5)